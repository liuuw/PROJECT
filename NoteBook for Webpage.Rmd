...
Also, some of the correlation coefficients among my independent variables are too high,like "TotalRevenuePerStudent," "TotalFederalRevenuePerStudent," "TotalLocalRevenuePerStudent" and    "TotalStateRevenuePerStudent," which may affect the accuracy of the analysis. 
```{r}
