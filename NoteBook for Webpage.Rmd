...
Let's see the revenue difference among these 39 counties and sort by their budget. (ggplot)
```{r}
library(ggthemes)
library(tidyverse)
library(ggplot2)
...
We run logistic regression and find out that the binomianl variable (Region: Urban/ country) don't  affect those variables and don't reach a siginificant level statistically.
```{r}
